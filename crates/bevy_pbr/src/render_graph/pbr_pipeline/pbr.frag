...
#    if defined(STANDARDMATERIAL_OCCLUSION_TEXTURE) && !defined(STANDARDMATERIAL_OCCLUSION_SHARES_METALLIC_ROUGHNESS_TEXTURE)
...
#    elif defined(STANDARDMATERIAL_OCCLUSION_TEXTURE)
