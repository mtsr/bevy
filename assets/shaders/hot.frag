...
void main() {
    ...
    float distance_along_plane = distance_sign * sqrt(dot(perpendicular_component, perpendicular_component)) / sqrt(dot(perpendicular_component_p1, perpendicular_component_p1));
